...
docker create --name=l3host32 --hostname=l3host32 --net=none chost:0.1
...
docker create --name=l3host31 --hostname=l3host31 --net=none chost:0.1
...
docker create --name=l3host12 --hostname=l3host12 --net=none chost:0.1
