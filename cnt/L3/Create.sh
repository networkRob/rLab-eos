...
sudo ovs-vsctl add-br l3spine1border1
sudo ovs-vsctl set bridge l3spine1border1 other-config:forward-bpdu=true
sudo ovs-vsctl add-br l3spine1border2
sudo ovs-vsctl set bridge l3spine1border2 other-config:forward-bpdu=true
...
sudo ovs-vsctl add-br l3spine2border1
sudo ovs-vsctl set bridge l3spine2border1 other-config:forward-bpdu=true
sudo ovs-vsctl add-br l3spine2border2
sudo ovs-vsctl set bridge l3spine2border2 other-config:forward-bpdu=true
...
sudo ovs-docker add-port l3spine1border1 eth7 l3spine1
sudo ovs-docker add-port l3spine1border2 eth8 l3spine1
...
sudo ovs-docker add-port l3spine2border1 eth7 l3spine2
