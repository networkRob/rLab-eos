...
sudo cp -r $(pwd)/configs/RATD/eos16/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos16)/
...
sudo cp -r $(pwd)/configs/RATD/eos9/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos9)/
...
sudo cp -r $(pwd)/configs/RATD/eos8/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos8)/
...
sudo cp -r $(pwd)/configs/RATD/eos5/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos5)/
...
sudo cp -r $(pwd)/configs/RATD/eos4/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos4)/
...
sudo cp -r $(pwd)/configs/RATD/eos7/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos7)/
...
sudo cp -r $(pwd)/configs/RATD/eos6/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos6)/
...
sudo cp -r $(pwd)/configs/RATD/eos1/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos1)/
...
sudo cp -r $(pwd)/configs/RATD/eos10/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos10)/
...
sudo cp -r $(pwd)/configs/RATD/eos3/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos3)/
...
sudo cp -r $(pwd)/configs/RATD/eos2/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos2)/
...
sudo cp -r $(pwd)/configs/RATD/eos15/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos15)/
...
sudo cp -r $(pwd)/configs/RATD/eos20/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos20)/
...
sudo cp -r $(pwd)/configs/RATD/eos13/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos13)/
...
sudo cp -r $(pwd)/configs/RATD/eos14/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos14)/
...
sudo cp -r $(pwd)/configs/RATD/eos19/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos19)/
...
sudo cp -r $(pwd)/configs/RATD/eos12/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos12)/
...
sudo cp -r $(pwd)/configs/RATD/eos11/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos11)/
...
sudo cp -r $(pwd)/configs/RATD/eos17/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos17)/
...
sudo cp -r $(pwd)/configs/RATD/eos18/* $(docker volume inspect --format '{{ .Mountpoint }}' ratdeos18)/
