...
docker exec -it atdspine1 bash pkill -9 Sysdb
...
docker exec -it atdspine2 bash pkill -9 Sysdb
...
docker exec -it atdleaf1 bash pkill -9 Sysdb
...
docker exec -it atdleaf2 bash pkill -9 Sysdb
...
docker exec -it atdleaf3 bash pkill -9 Sysdb
...
docker exec -it atdleaf4 bash pkill -9 Sysdb
...
docker exec -it atdhost1 bash pkill -9 Sysdb
...
docker exec -it atdhost2 bash pkill -9 Sysdb
