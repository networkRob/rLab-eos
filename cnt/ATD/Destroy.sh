#!/bin/bash
sudo ovs-docker del-port vmgmt et0 atdhost1 --ipaddress=192.168.0.31/24
...
docker rm atdhost1
sudo ovs-docker del-port vmgmt et0 atdspine1 --ipaddress=192.168.0.10/24
...
docker rm atdspine1
sudo ovs-docker del-port vmgmt et0 atdleaf4 --ipaddress=192.168.0.17/24
...
docker rm atdleaf4
sudo ovs-docker del-port vmgmt et0 atdspine2 --ipaddress=192.168.0.11/24
...
docker rm atdspine2
sudo ovs-docker del-port vmgmt et0 atdleaf1 --ipaddress=192.168.0.14/24
...
docker rm atdleaf1
sudo ovs-docker del-port vmgmt et0 atdhost2 --ipaddress=192.168.0.32/24
...
docker rm atdhost2
sudo ovs-docker del-port vmgmt et0 atdleaf3 --ipaddress=192.168.0.16/24
...
docker rm atdleaf3
sudo ovs-docker del-port vmgmt et0 atdleaf2 --ipaddress=192.168.0.15/24
