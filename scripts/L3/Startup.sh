#!/bin/bash
ip netns add L3
ip link add l3spine1et1 type veth peer name l3leaf11et2
ip link add l3spine1et2 type veth peer name l3leaf12et2
ip link add l3spine1et3 type veth peer name l3leaf21et2
ip link add l3spine1et4 type veth peer name l3leaf22et2
ip link add l3spine1et5 type veth peer name l3leaf31et2
ip link add l3spine1et6 type veth peer name l3leaf32et2
ip link add l3spine1et7 type veth peer name l3brdr1et2
ip link add l3spine1et8 type veth peer name l3brdr2et2
ip link add l3spine2et1 type veth peer name l3leaf11et3
ip link add l3spine2et2 type veth peer name l3leaf12et3
ip link add l3spine2et3 type veth peer name l3leaf21et3
ip link add l3spine2et4 type veth peer name l3leaf22et3
ip link add l3spine2et5 type veth peer name l3leaf31et3
ip link add l3spine2et6 type veth peer name l3leaf32et3
ip link add l3spine2et7 type veth peer name l3brdr1et3
ip link add l3spine2et8 type veth peer name l3brdr2et3
ip link add l3leaf11et1 type veth peer name l3leaf12et1
ip link add l3leaf11et4 type veth peer name l3host11et0
ip link add l3leaf11et5 type veth peer name l3host12et0
ip link add l3leaf21et1 type veth peer name l3leaf22et1
ip link add l3leaf21et4 type veth peer name l3host21et0
ip link add l3leaf22et4 type veth peer name l3host22et0
ip link add l3leaf31et1 type veth peer name l3leaf32et1
ip link add l3leaf31et4 type veth peer name l3host31et0
ip link add l3leaf31et5 type veth peer name l3host32et0
ip link add l3brdr1et1 type veth peer name l3brdr2et1
docker start l3spine1-net
docker stop l3spine1
docker rm l3spine1
l3spine1pid=$(docker inspect --format '{{.State.Pid}}' l3spine1-net)
ln -sf /proc/${l3spine1pid}/ns/net /var/run/netns/l3spine1
ip link set l3spine1et1 netns l3spine1 name et1 up
ip link set l3spine1et2 netns l3spine1 name et2 up
ip link set l3spine1et3 netns l3spine1 name et3 up
ip link set l3spine1et4 netns l3spine1 name et4 up
ip link set l3spine1et5 netns l3spine1 name et5 up
ip link set l3spine1et6 netns l3spine1 name et6 up
ip link set l3spine1et7 netns l3spine1 name et7 up
ip link set l3spine1et8 netns l3spine1 name et8 up
sleep 1
...
ln -sf /proc/${l3spine2pid}/ns/net /var/run/netns/l3spine2
ip link set l3spine2et1 netns l3spine2 name et1 up
ip link set l3spine2et2 netns l3spine2 name et2 up
ip link set l3spine2et3 netns l3spine2 name et3 up
ip link set l3spine2et4 netns l3spine2 name et4 up
ip link set l3spine2et5 netns l3spine2 name et5 up
ip link set l3spine2et6 netns l3spine2 name et6 up
ip link set l3spine2et7 netns l3spine2 name et7 up
ip link set l3spine2et8 netns l3spine2 name et8 up
sleep 1
...
ln -sf /proc/${l3leaf11pid}/ns/net /var/run/netns/l3leaf11
ip link set l3leaf11et1 netns l3leaf11 name et1 up
ip link set l3leaf11et2 netns l3leaf11 name et2 up
ip link set l3leaf11et3 netns l3leaf11 name et3 up
ip link set l3leaf11et4 netns l3leaf11 name et4 up
ip link set l3leaf11et5 netns l3leaf11 name et5 up
sleep 1
...
ln -sf /proc/${l3leaf12pid}/ns/net /var/run/netns/l3leaf12
ip link set l3leaf12et1 netns l3leaf12 name et1 up
ip link set l3leaf12et2 netns l3leaf12 name et2 up
ip link set l3leaf12et3 netns l3leaf12 name et3 up
sleep 1
...
ln -sf /proc/${l3leaf21pid}/ns/net /var/run/netns/l3leaf21
ip link set l3leaf21et1 netns l3leaf21 name et1 up
ip link set l3leaf21et2 netns l3leaf21 name et2 up
ip link set l3leaf21et3 netns l3leaf21 name et3 up
ip link set l3leaf21et4 netns l3leaf21 name et4 up
sleep 1
...
ln -sf /proc/${l3leaf22pid}/ns/net /var/run/netns/l3leaf22
ip link set l3leaf22et1 netns l3leaf22 name et1 up
ip link set l3leaf22et2 netns l3leaf22 name et2 up
ip link set l3leaf22et3 netns l3leaf22 name et3 up
ip link set l3leaf22et4 netns l3leaf22 name et4 up
sleep 1
...
ln -sf /proc/${l3leaf31pid}/ns/net /var/run/netns/l3leaf31
ip link set l3leaf31et1 netns l3leaf31 name et1 up
ip link set l3leaf31et2 netns l3leaf31 name et2 up
ip link set l3leaf31et3 netns l3leaf31 name et3 up
ip link set l3leaf31et4 netns l3leaf31 name et4 up
ip link set l3leaf31et5 netns l3leaf31 name et5 up
sleep 1
...
ln -sf /proc/${l3leaf32pid}/ns/net /var/run/netns/l3leaf32
ip link set l3leaf32et1 netns l3leaf32 name et1 up
ip link set l3leaf32et2 netns l3leaf32 name et2 up
ip link set l3leaf32et3 netns l3leaf32 name et3 up
sleep 1
...
ln -sf /proc/${l3brdr1pid}/ns/net /var/run/netns/l3brdr1
ip link set l3brdr1et1 netns l3brdr1 name et1 up
ip link set l3brdr1et2 netns l3brdr1 name et2 up
ip link set l3brdr1et3 netns l3brdr1 name et3 up
sleep 1
...
ln -sf /proc/${l3brdr2pid}/ns/net /var/run/netns/l3brdr2
ip link set l3brdr2et1 netns l3brdr2 name et1 up
ip link set l3brdr2et2 netns l3brdr2 name et2 up
ip link set l3brdr2et3 netns l3brdr2 name et3 up
sleep 1
...
ln -sf /proc/${l3host11pid}/ns/net /var/run/netns/l3host11
ip link set l3host11et0 netns l3host11 name et0 up
sleep 1
...
ln -sf /proc/${l3host12pid}/ns/net /var/run/netns/l3host12
ip link set l3host12et0 netns l3host12 name et0 up
sleep 1
...
ln -sf /proc/${l3host21pid}/ns/net /var/run/netns/l3host21
ip link set l3host21et0 netns l3host21 name et0 up
sleep 1
...
ln -sf /proc/${l3host22pid}/ns/net /var/run/netns/l3host22
ip link set l3host22et0 netns l3host22 name et0 up
sleep 1
...
ln -sf /proc/${l3host31pid}/ns/net /var/run/netns/l3host31
ip link set l3host31et0 netns l3host31 name et0 up
sleep 1
...
ln -sf /proc/${l3host32pid}/ns/net /var/run/netns/l3host32
ip link set l3host32et0 netns l3host32 name et0 up
sleep 1
