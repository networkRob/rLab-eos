...
sudo podman start l3spine1-net
...
sudo podman start l3spine2-net
...
sudo podman start l3leaf11-net
...
sudo podman start l3leaf12-net
...
sudo podman start l3leaf21-net
...
sudo podman start l3leaf22-net
...
sudo podman start l3leaf31-net
...
sudo podman start l3leaf32-net
...
sudo podman start l3host11-net
...
sudo podman start l3host12-net
...
sudo podman start l3host21-net
...
sudo podman start l3host22-net
...
sudo podman start l3host31-net
...
sudo podman start l3host32-net
