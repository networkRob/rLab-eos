...
docker run -d --restart=always --name=l2spine1-net --net=none busybox /bin/init
...
docker run -d --restart=always --name=l2spine2-net --net=none busybox /bin/init
...
docker run -d --restart=always --name=l2leaf1-net --net=none busybox /bin/init
...
docker run -d --restart=always --name=l2leaf2-net --net=none busybox /bin/init
...
docker run -d --restart=always --name=l2leaf3-net --net=none busybox /bin/init
...
docker run -d --restart=always --name=l2host10-net --net=none busybox /bin/init
...
docker run -d --restart=always --name=l2host11-net --net=none busybox /bin/init
...
docker run -d --restart=always --name=l2host20-net --net=none busybox /bin/init
...
docker run -d --restart=always --name=l2host21-net --net=none busybox /bin/init
...
docker run -d --restart=always --name=l2host30-net --net=none busybox /bin/init
...
docker run -d --restart=always --name=l2host31-net --net=none busybox /bin/init
